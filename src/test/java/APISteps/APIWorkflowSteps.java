...
public class APIWorkflowSteps {
    ...
    public void a_request_is_prepared_to_create_an_employee() {
        ...
        //APICommonMethods.createEmployeeRequest(apiPayloadConstants.createEmployeePayload());
    }
    ...
    public void the_employee_created_contains_key_and_value(String message, String string2) {
    ...
    *----------------------------------------------
    ...
    public void a_request_is_prepared_ot_retrieve_the_created_employee() {
      request = given().header( apiConstants.Header_Content_type, apiConstants.Content_type )
    ...
    @Then("the retrieved employee ID {string} matched the globally stored employee ID")
    public void the_retrieved_employee_id_matched_the_globally_stored_employee_id(String employeeIDfromResponse) {
